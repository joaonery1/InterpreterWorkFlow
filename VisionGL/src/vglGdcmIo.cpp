...
#include </usr/local/include/gdcm-2.4/gdcmImageReader.h>
#include </usr/local/include/gdcm-2.4/gdcmImage.h>
#include </usr/local/include/gdcm-2.4/gdcmWriter.h>
#include </usr/local/include/gdcm-2.4/gdcmAttribute.h>
#include </usr/local/include/gdcm-2.4/gdcmImageWriter.h>
#include </usr/local/include/gdcm-2.4/gdcmImageChangeTransferSyntax.h>
#include "/usr/local/include/gdcm-2.4/gdcmImageChangeTransferSyntax.h"
#include "/usr/local/include/gdcm-2.4/gdcmImageChangePhotometricInterpretation.h"
#include "/usr/local/include/gdcm-2.4/gdcmPhotometricInterpretation.h"
